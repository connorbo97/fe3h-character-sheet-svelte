...
export const PLAYER_SKILL_TO_STAT = {
	...
	[PLAYER_SKILL.BARTERING]: [PLAYER_STAT.WIS, PLAYER_STAT.CHA],
	[PLAYER_SKILL.CLEANING]: [PLAYER_STAT.CON, PLAYER_STAT.WIS],
	[PLAYER_SKILL.COOKING]: [PLAYER_STAT.INT, PLAYER_STAT.WIS],
	[PLAYER_SKILL.DECEPTION]: PLAYER_STAT.CHA,
	[PLAYER_SKILL.GARDENING]: [PLAYER_STAT.STR, PLAYER_STAT.CON, PLAYER_STAT.WIS],
	[PLAYER_SKILL.GUARD_DUTY]: [PLAYER_STAT.CON, PLAYER_STAT.WIS],
	[PLAYER_SKILL.HISTORY]: PLAYER_STAT.INT,
	[PLAYER_SKILL.HUNTING]: [PLAYER_STAT.WIS, PLAYER_STAT.DEX],
...
export const PLAYER_SKILL_TO_LABEL = {
	...
	[PLAYER_SKILL.BARTERING]: 'Bartering',
	[PLAYER_SKILL.CLEANING]: 'Cleaning',
	[PLAYER_SKILL.COOKING]: 'Cooking',
	[PLAYER_SKILL.DECEPTION]: 'Deception',
	[PLAYER_SKILL.GARDENING]: 'Gardening',
	[PLAYER_SKILL.GUARD_DUTY]: 'Guard Duty',
	[PLAYER_SKILL.HISTORY]: 'History',
	[PLAYER_SKILL.HUNTING]: 'Hunting/Fishing',
